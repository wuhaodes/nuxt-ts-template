...
<div class="navigation">
  <div style="width: 1280px;margin: 0 auto">
    <div class="navigation_logo fl">
      ...
      <span class="logo_title">铭码集团排版打印系统
      ...
      <div class="bar fr">
        <el-menu :default-active="activeRouter" @select="handleSelect" class="el-menu-demo" mode="horizontal">
          <el-menu-item index="/mp/home">
            <nuxt-link style="padding: 26px 20px;" to="/mp/home">
              控制台
            </nuxt-link>
          </el-menu-item>
          <el-menu-item index="/mp/graph">
            <nuxt-link style="padding: 26px 20px;" to="/mp/graph">
              模版管理
            </nuxt-link>
          </el-menu-item>
<!--          <el-menu-item index="/mp/type_list">-->
<!--            <nuxt-link style="padding: 26px 20px;" to="/mp/type_list">-->
<!--              类型管理-->
<!--            </nuxt-link>-->
<!--          </el-menu-item>-->
        </el-menu>
