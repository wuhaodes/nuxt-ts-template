...
<div v-if="form">
  <el-form :model="form" :rules="rules" class="adminForm" label-width="120px" ref="form">
    ...
    <!--        <el-select disabled placeholder="请选择人员身份" v-model="form.role">-->
    <!--          &lt;!&ndash;          //角色  system 管理员&ndash;&gt;-->
    <!--          &lt;!&ndash;          //  system.design 设计管理员  system.design.work 设计人员&ndash;&gt;-->
    <!--          &lt;!&ndash;          //  system.product 生产管理员  system.product.work  生产人员&ndash;&gt;-->
